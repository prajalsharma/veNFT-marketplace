...
export default function DocsPage() {
  const sections = [
    {
      title: "Introduction",
      content: "Vezo is a production-grade, escrowless P2P marketplace designed specifically for the Mezo ecosystem. It enables users to trade vote-escrowed Bitcoin (veBTC) and MEZO (veMEZO) positions with maximum transparency and security.",
      icon: Zap,
    },
    {
