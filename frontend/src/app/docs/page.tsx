...
export default function DocsPage() {
  const sections = [
    {
      title: "Introduction",
      content: "The Mezo veNFT Marketplace is a production-grade, escrowless P2P platform designed specifically for the Mezo ecosystem. It enables users to trade vote-escrowed Bitcoin (veBTC) and MEZO (veMEZO) positions with maximum transparency and security.",
      icon: Zap,
    },
    {
    ...
    },
    {
      ...
      content: "Security is our top priority. The marketplace uses an escrowless architecture, meaning your veNFTs stay in your wallet until the exact moment of sale. Buyers pay directly to the seller (minus a small protocol fee), and the NFT is transferred in a single atomic transaction.",
      icon: Shield,
    }
  ];
          ...
          <section>
            ...
            <div className="space-y-6">
              ...
              <div className="glass-card p-6 rounded-2xl">
                ...
                <p className="text-mezo-muted mb-4">A specialized abstraction layer that communicates with Mezo's internal locking contracts to calculate intrinsic value and voting power decay.</p>
                <div className="flex gap-4">
              ...
              <div className="grid md:grid-cols-2 gap-12">
                ...
                <div className="bg-mezo-background/50 rounded-2xl p-6 border border-mezo-border">
                  ...
                  <div className="space-y-2 text-sm font-mono text-mezo-muted">
                    <p className="text-mezo-success">[✓] No Unlimited Approvals</p>
                    <p className="text-mezo-success">[✓] Integer Overflow Protection (Solidity 0.8+)</p>
                    <p className="text-mezo-success">[✓] Atomic Buy/Transfer</p>
                    <p className="text-mezo-success">[✓] Timelocked Fee Changes</p>
                    <p className="text-mezo-warning">[!] Whitelist Restricted</p>
                  </div>
                </div>
              </div>
            </div>
