          ...
          <section>
            ...
            <div className="space-y-6">
              ...
              <div className="glass-card p-6 rounded-2xl">
                ...
                <p className="text-mezo-muted mb-4">Routes payments from buyer to seller with protocol fee deduction. Supports native BTC and ERC-20 tokens (MEZO, MUSD). Restricted to marketplace-only calls — no external address can trigger payment routing.</p>
                <div className="flex gap-4">
              ...
              <div className="grid md:grid-cols-2 gap-12">
                ...
                <div className="bg-mezo-background/50 rounded-2xl p-6 border border-mezo-border">
                  ...
                  <div className="space-y-2 text-sm font-mono text-mezo-muted">
                    ...
                    <p className="text-mezo-success">[✓] Protocol fee hardcapped at 5%</p>
