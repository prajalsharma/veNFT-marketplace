      ...
      <div className="flex items-center gap-6">
        ...
        <div>
          ...
          <div className="flex items-center gap-3 mt-1">
            ...
            <span className="text-sm font-black text-white">{parseFloat(listing.price.toString()) / 1e18} {(listing.paymentToken?.toLowerCase() === '0x7b7c000000000000000000000000000000000001' ? 'MEZO' : (listing.paymentToken?.toLowerCase() ?? '').length > 10 && listing.paymentToken?.toLowerCase() !== '0x7b7c000000000000000000000000000000000000' && listing.paymentToken?.toLowerCase() !== '0x7b7c000000000000000000000000000000000001' ? 'MUSD' : 'BTC')}</span>
          </div>
        </div>
      </div>
