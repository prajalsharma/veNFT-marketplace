...
export const CONTRACTS = {
  testnet: {
    ...
    marketplace: getEnvAddress("NEXT_PUBLIC_MARKETPLACE_TESTNET", "0x293ba099c5Cf32af54013F00fEe8D2EA1cad8570"),
    adapter:     getEnvAddress("NEXT_PUBLIC_ADAPTER_TESTNET",     "0x8EC595099030aB282511c87cAF104E734418Eff5"),
    router:      getEnvAddress("NEXT_PUBLIC_ROUTER_TESTNET",      "0xA4098F23aA2883DA13A714982d89BFB403718fb9"),
    admin:       getEnvAddress("NEXT_PUBLIC_ADMIN_TESTNET",       "0x5bBc2d83D0786Bf2Bc56096d832e6B7cfcca9396"),
  },
  mainnet: {
    chainId: 31612,
