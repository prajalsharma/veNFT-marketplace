...
export const CONTRACTS = {
  ...
  mainnet: {
    ...
    // Marketplace contracts — not yet deployed on mainnet (pending security audit)
    marketplace: getEnvAddress("NEXT_PUBLIC_MARKETPLACE_MAINNET", "0x0000000000000000000000000000000000000000"),
    adapter:     getEnvAddress("NEXT_PUBLIC_ADAPTER_MAINNET",     "0x0000000000000000000000000000000000000000"),
    router:      getEnvAddress("NEXT_PUBLIC_ROUTER_MAINNET",      "0x0000000000000000000000000000000000000000"),
    admin:       getEnvAddress("NEXT_PUBLIC_ADMIN_MAINNET",       "0x0000000000000000000000000000000000000000"),
  },
} as const;
