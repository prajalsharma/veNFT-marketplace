...
The market prices veNFTs relative to intrinsic value (the tokens locked inside, shown in the listing flow). Some guidelines:
...
If you transfer the NFT elsewhere while listed, the listing becomes dead. Any purchase attempt reverts (a buyer-protection check), but the stale listing lingers until cleaned up. Cancel first, then move.
:::
